...
/**
 * 自定义的布局，用来管理三个子控件， 下拉头， GroupView ， 上拉头
 *
 * @author wjh
 */
public class PullSlipLayout extends RelativeLayout {
    // 初始状态
    ...
    public PullSlipLayout(Context context) {
        super(context);
        initView(context);
    }

    public PullSlipLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public PullSlipLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void refreshFinish() {
        ...
        new Handler() {
            @Override
            public void handleMessage(Message msg) {
                refreshFinish(PullSlipLayout.SUCCEED);
            }
